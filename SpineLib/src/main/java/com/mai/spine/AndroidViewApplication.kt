...
//    protected lateinit var audio: AndroidAudio
    ...
    private fun init(listener: ApplicationListener, config: AndroidApplicationConfiguration) {
        ...
        mInput = createInput(this, mActivity, graphics.view, config)
...
//        audio = AndroidAudio(mActivity, config)
        ...
        files = DefaultAndroidFiles(mActivity.assets, mActivity,true)
...
//                audio.dispose()
    ...
    override fun getAudio(): Audio {
        return DefaultAndroidAudio(mActivity,AndroidApplicationConfiguration())
    }
